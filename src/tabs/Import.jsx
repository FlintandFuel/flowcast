...
function PreviewTable({ rows, setRows, onConfirm, onCancel, confirming }) {
  ...
  return (
    <div className="space-y-3">
      <div className="text-xs text-gray-500">{includedCount} of {rows.length} rows will be imported</div>
      ...
      <div className="flex gap-3">
        <button onClick={onCancel} className="flex-1 py-2.5 rounded-lg border border-gray-700 text-gray-300 min-h-[44px]">
          Cancel
        </button>
        <button
          onClick={onConfirm}
...
function SuccessSummary({ summary, onDone }) {
  return (
    <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 space-y-2">
      ...
      <div className="text-gray-400 text-sm">{summary.count} transactions imported</div>
...
function CsvImport({ user }) {
  ...
  return (
    <div className="space-y-3">
      ...
      <label className="flex flex-col items-center justify-center border border-dashed border-gray-700 rounded-xl py-8 cursor-pointer text-gray-500 text-sm">
      ...
      {headers.length > 0 && (
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-3 space-y-2">
          ...
          <label className="flex items-center gap-2 text-xs text-gray-500 py-1">
            <input
              type="checkbox"
          ...
          <div className="text-[10px] text-gray-600">{rawRows.length} rows found</div>
...
function ScreenshotImport({ user }) {
  ...
  return (
    <div className="space-y-3">
      <label className="flex flex-col items-center justify-center border border-dashed border-gray-700 rounded-xl py-8 cursor-pointer text-gray-500 text-sm overflow-hidden">
        {imageUrl ? (
      ...
      <div className="flex rounded-lg overflow-hidden border border-gray-800">
        <button
          ...
          className={`flex-1 py-2.5 text-sm font-medium min-h-[44px] transition ${
            method === "csv" ? "bg-blue-500 text-white" : "text-gray-500"
          }`}
        >
          CSV Upload
        </button>
        <button
          ...
          className={`flex-1 py-2.5 text-sm font-medium min-h-[44px] transition ${
            method === "screenshot" ? "bg-blue-500 text-white" : "text-gray-500"
          }`}
        >
          Screenshot
        </button>
